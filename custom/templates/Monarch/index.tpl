          ...
          <div class="ui fluid card" id="news-post">
            <div class="content">
              <div class="header">
                ...
                <img class="ui avatar image" src="{$item.author_avatar}" alt="{$item.author_name}"><a href="{$item.url}" data-toggle="popup">{$item.title}</a>
              ...
              <div class="meta" data-toggle="tooltip" data-content="{$item.date}">
                <a style="{$item.author_style}" href="{$item.author_url}" data-poload="{$USER_INFO_URL}{$item.author_id}">{$item.author_name}</a> {$item.time_ago}
              </div>
              <hr>
